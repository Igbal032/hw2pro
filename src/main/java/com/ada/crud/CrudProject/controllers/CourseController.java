...
import com.ada.crud.CrudProject.exception.StudentAndCourseException;
...
public class CourseController {
    ...
    public String update(Model model,Course course, BindingResult bRes) {
    try{
...
//        }
    ...
    public String addCourse(Model model, Course newCourses, BindingResult bRes) {
