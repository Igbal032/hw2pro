package com.ada.crud.CrudProject.controllers;

import com.ada.crud.CrudProject.Entity.Course;
import com.ada.crud.CrudProject.Entity.Student;
import com.ada.crud.CrudProject.Repository.courseRepository;
import com.ada.crud.CrudProject.Repository.studentRepository;
...
public class StudentController {
    com.ada.crud.CrudProject.Repository.courseRepository courseRepository;
    studentRepository studentRepository;
    static Student keepSt;
    Logger logger = LoggerFactory.getLogger(this.getClass());
    public StudentController(com.ada.crud.CrudProject.Repository.studentRepository sr, courseRepository cr){
...
//        Iterable<Student> students = studentRepository.findAll();
    ...
    public String update(Model model, Student student, BindingResult bindingResult) {
...
//        }
    ...
    public String add(Model model,Student newStudent, BindingResult bindingResult) {
